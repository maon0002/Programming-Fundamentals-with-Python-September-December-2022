...
# The text will come in the form of strings, each representing a sentence. You need to extract only the valid links from it. Example:
#
# "www.internet.com"
#
...
# (uppercase and lowercase), digits, and dashes ("–").
# The Domain extension consists of one or more domain blocks, a domain block consists of a dot
# followed by one or more lowercase English alphabet letters, a Domain extension must have
# at least one domain block in order to be valid.
